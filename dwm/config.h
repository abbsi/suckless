...
static Key keys[] = {
  ...
  { ControlMask,          XK_Print,    spawn, CMD("sleep 1s; shot") },
  { ShiftMask,            XK_Print,    spawn, CMD("sleep 1s; shot focused") },
  { 0,                    XK_Print,    spawn, CMD("sleep 1s; shot select") },
  { MODKEY,               XK_l,        spawn, CMD("slock") },
  { Mod1Mask|ControlMask, XK_Print,    spawn, CMD("m-scrot") },
